...
for (analysis in analyses) {
  path <- file.path("/Users/derekwong/Desktop/H4H/projects/CHARM/LFS/griffin_all/output/nucleosome_profiling", analysis, "coverage")
  outdir <- file.path("/Users/derekwong/OneDrive - UHN/Post-Doc/CHARM_Project/LFS/griffin_all", analysis)
  project <- "CHARM_LFS"
