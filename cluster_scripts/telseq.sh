...
PDIR=/cluster/projects/pughlab/projects/CHARM/LFS/telseq
...
/cluster/projects/pughlab/bin/TelSeq/telseq-master/bin/linux/telseq\
 $INPUTDIR/${bam}.bam > $outdir/${bam}_telseq.txt
