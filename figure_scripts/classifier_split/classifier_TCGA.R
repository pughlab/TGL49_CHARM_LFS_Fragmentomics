...
saveRDS(outcomes_neg_test, file.path(outdir, "outcomes_TCGA_DHS_status_test.rds"))
saveRDS(outcomes_neg_val, file.path(outdir, "outcomes_TCGA_DHS_status_val.rds"))
...
saveRDS(outcomes_lfs_test, file.path(outdir, "outcomes_TCGA_DHS_lfs_test.rds"))
saveRDS(outcomes_lfs_val, file.path(outdir, "outcomes_TCGA_DHS_lfs_val.rds"))
