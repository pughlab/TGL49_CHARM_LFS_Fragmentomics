...
plot_pca
ggsave(file.path(outdir, "fragment_nucleosome_TCGA_pca.pdf"), plot_pca, width = 4, height = 3.5)
...
### Plot clustering
pdf(file.path(outdir, "fragment_nucleosome_TCGA_clustering.pdf"), height = 2.5, width = 4)
