...
outcomes_lfs_butler <- But.kfold
saveRDS(outcomes_lfs, file.path(path, "outcomes_integrated_lfs.rds"))
saveRDS(outcomes_lfs_butler, file.path(path, "outcomes_integrated_lfs_butler.rds"))
